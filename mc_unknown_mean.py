...
\\item LW = Local Whittle, V = Velasco (Kolmogorov), HC = Hurvich--Chen, ELW = Exact Local Whittle, 2ELW = Two-step ELW with adaptive mean estimation applied to original series, LWLFC = Local Whittle robust to low-frequency contamination.
\\end{{tablenotes}}
\\end{{threeparttable}}
\\end{{table}}
"""
