...
echo "[7/16] Running Tables 7, 14, and 15 (Comprehensive Comparison; n = 500, 250, 1000)"
...
echo "[15/16] Running Table 16: mc_comprehensive_ma.py (MA(1) Short-Run Dynamics)"
python3 mc_comprehensive_ma.py 2>&1 | tee logs/mc_comprehensive_ma.log
echo ""

echo "[16/16] Running Table 17: mc_comprehensive_arma.py (ARMA(1,1) Short-Run Dynamics)"
